module.exports = {
	Auth: {
    	CreateApiKey: 'https://haapi.ankama.com/json/Ankama/v2/Api/CreateApiKey',
    	CreateToken: 'https://haapi.ankama.com/json/Ankama/v2/Account/CreateToken?game=18'
	},
	Versions: {
		...
		App: 'https://itunes.apple.com/lookup?country=fr&id=1041406978&lang=fr&limit=1&t=' + Date.now(),
